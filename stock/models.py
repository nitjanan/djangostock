...
class PoDownloadLog(models.Model):
    id = models.AutoField(primary_key=True)
    po = models.ForeignKey(PurchaseOrder,on_delete=models.CASCADE, null=True)
    downloadAt = models.DateTimeField(default=timezone.now, verbose_name="วันที่ดาวน์โหลด")
    downloadUser = models.ForeignKey(User, on_delete=models.CASCADE, null=True, blank=True, verbose_name="ผู้โหลด")
